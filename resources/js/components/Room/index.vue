                    ...
                    <div class="card">
                        <div class="card-body d-flex justify-content-between align-items-center">
                            <div class="card-title mb-0">
                                <h4 class="mb-0">All  Room</h4>
                            </div>
                            <div class="card-action">
                                
                                 <router-link  class="btn btn-info"  to="/store-room" >
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <td>
                                                            <div class="flex align-items-center list-user-action">
                                                                ...
                                                                <a class="btn btn-sm btn-icon btn-danger" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete" @click="deleteRoom(room.id)">
                                                                    <span class="btn-inner">
