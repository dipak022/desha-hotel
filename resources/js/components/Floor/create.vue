                                            ...
                                            <div class="form-group">
                                             ...
                                             <div class="form-group">
                                                ...
                                                <select class="form-control" v-model="form.floor_cat_id">
                                                    ...
                                                    <option :value="floorcategorie.id" v-for="floorcategorie in floorcategories" >{{ floorcategorie.name }}</option>
                                                    
                                                </select> 
                                                <small class="text-danger" v-if="errors.floor_cat_id">{{ errors.floor_cat_id[0] }}</small>
                                            </div>
...
export default {
    ...
    methods:{
        customertypeInsert(){
            ...
            axios.post('/api/floor/',this.form)
            .then(()=>{
                Toast.fire({
                    icon: 'success',
