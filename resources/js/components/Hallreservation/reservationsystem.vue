                                                ...
                                                <div class="container">
                                                    ...
                                                    <ul class="list-group">
                                                        ...
                                                        >
                                                            ...
                                                            <span
                                                                class="badge"
                                                                style="margin-left: 180px; color: black ;text-align:center;"
                                                                >{{
                                                                    qty
                                                                }}
                                                                Item</span
                                                        ...
                                                        >
                                                            ...
                                                            <span
                                                                class="badge"
                                                                style="margin-left: 200px; color: black ;text-align:center;"
                                                                >{{
                                                                    subtotal
                                                                }}
                                                                tk</span
                                                        ...
                                                        >
                                                            ...
                                                            <span
                                                                class="badge"
                                                                style="margin-left: 250px; color: black;text-align:center;"
                                                                >{{
                                                                    vats.vat
                                                                }}
                                                                %</span
                                                        ...
                                                        >
                                                            ...
                                                            <span
                                                                class="badge"
                                                                style="margin-left: 230px; color: black ;text-align:center;"
                                                                >{{
                                                                    (subtotal *
                                                                        vats.vat) /
                                                                        100 +
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="row">
                        <div class="col-lg-12">
                                ...
                                >
                                    ...
                                    >
                                        <a
                                            ...
                                            aria-selected="false"
                                            @click="subProducts(categore.id)"
                                            >{{ categore.category_name }}</a
                                        >
                                    </li>
                                </ul>
                            ...
                            <div class="card">
                              <img
                                class="bg-soft-primary rounded"
                                :src="service.patho"
                                alt="profile"
                                id="em_patho"
                                style="width: 5rem; margin: center"
                              />
                              <div class="card-body">
                                <small class="">{{
                                ...
                                <td v-if="service.status >= 1">
                                  <span class="badge bg-success"
                                    >Available({{ service.status }} pics)</span
                                  >
                                </td>
                                <td v-else-if="service.status < 1">
                                    ...
                                    >
                                        <div class="card-body">
                                            ...
                                            >
                                                <div
                                                    class="col-lg-3 col-md-3 col-sm-3 col-6"
                                                    v-for="singleproduct in singlefiltersearch"
                                                    ...
                                                    >
                                                        <div class="card">
                                                            ...
                                                            >
                                                                ...
                                                                <td
                                                                    else="singleproduct.product_quantaty<1"
                                                                >
                                                                    <span
    ...
    computed: {
        filtersearch() {
            return this.services.filter(service => {
                return service.services_name.match(this.searchTerm);
            });
        },
        singlefiltersearch() {
            return this.getServices.filter(getService => {
                return getService.services_name.match(this.getsearchTerm);
            });
        },
        qty() {
            let sum = 0;
            for (let i = 0; i < this.carts.length; i++) {
                sum = sum + parseFloat(this.carts[i].ser_quentity);
            }
            return sum;
        },
        subtotal() {
            let sum = 0;
            for (let i = 0; i < this.carts.length; i++) {
                sum = sum + parseFloat(this.carts[i].ser_total);
            }
            return sum;
        },
        FindHallBooked(){
